...
import '../../students/StudentView/StudentView.css';


class FeesStudents extends Component {
    constructor() {
        super()
        this.state = {
            all_students: [],
                    ...
                    <div className="mainBodyStud">
                        ...
                        <div className="buttonBar">
                            <div className="updateBtns">
                                <Link to={`/fees/student/${this.state.checked}`}><button>View</button></Link>
                                <Link to='/fees/main'>
...
export default connect(null, { get_student_id })(FeesStudents);